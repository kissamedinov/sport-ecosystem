...
MatchModel _$MatchModelFromJson(Map<String, dynamic> json) => MatchModel(
  ...
  homePenaltyScore: (json['home_penalty_score'] as num?)?.toInt(),
  awayPenaltyScore: (json['away_penalty_score'] as num?)?.toInt(),
...
Map<String, dynamic> _$MatchModelToJson(MatchModel instance) =>
    <String, dynamic>{
      ...
      'home_penalty_score': instance.homePenaltyScore,
      'away_penalty_score': instance.awayPenaltyScore,
