...
class _ClubOwnerProfileBodyState extends State<ClubOwnerProfileBody> {
  ...
  Widget _buildActions(ClubDashboard dashboard) {
    return Column(
      children: [
        _buildActionButton("Manage All Teams", Icons.shield_outlined, PremiumTheme.neonGreen, () {
        ...
        _buildActionButton("Invite Professionals", Icons.person_add_rounded, PremiumTheme.electricBlue, () {
          Navigator.push(
            context,
            MaterialPageRoute(
