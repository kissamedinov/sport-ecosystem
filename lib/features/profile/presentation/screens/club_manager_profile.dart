...
class ClubManagerProfile extends StatelessWidget {
  final User user;

  const ClubManagerProfile({super.key, required this.user});
            ...
            children: [
              ...
              Container(
                ...
                child: const Column(
                  children: [
                    SizedBox(height: 4),
                    ClubOwnerProfileBody(isManager: true),
                    SizedBox(height: 40),
                  ],
                ),
              ),
