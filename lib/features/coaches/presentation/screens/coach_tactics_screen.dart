...
class _CoachTacticsScreenState extends State<CoachTacticsScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final formation = _formations.firstWhere((f) => f.name == _selected);
                  ...
                  child: AnimatedContainer(
                    ...
                    decoration: BoxDecoration(
                      color: active
                          ...
                          : PremiumTheme.electricBlue.withValues(alpha: 0.08),
                      borderRadius: BorderRadius.circular(12),
                      border: Border.all(
                        color: active
                            ? PremiumTheme.electricBlue
                            : PremiumTheme.electricBlue.withValues(alpha: 0.25),
                      ),
                    ),
                    child: Text(
                      f.name,
                      style: TextStyle(
                        color: active ? Colors.white : PremiumTheme.electricBlue,
