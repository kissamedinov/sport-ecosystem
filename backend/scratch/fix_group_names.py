...
def main():
    ...
    # 1. Declare Map in State class members
  ...
  final Map<String, String> _groupLettersMap = {};"""
    ...
    # 3. Update _cleanGroupName helper to lookup map first
  ...
  if (groupId != null && _groupLettersMap.containsKey(groupId)) {
    return _groupLettersMap[groupId]!;
  }
  if (groupName != null && _groupLettersMap.containsKey(groupName)) {
    return _groupLettersMap[groupName]!;
  }"""
